# Company of Heroes - Complete Walkthrough Guide

<div align="center">

## ⚔️ Complete Campaign Walkthrough ⚔️
*A comprehensive journey through World War II's greatest battles*
...
- 🎮 **Part 3: Liberation of Caen** - IN PROGRESS → [Mission 3: Carpiquet](#mission-3-carpiquet)
- ⬜ **Part 4: Tiger Ace** - Not Started
- ⬜ **Part 5: Causeway** - Not Started
- ⬜ **Part 6: Falaise Pocket** - Not Started

**Overall Progress:** 25/41 missions completed (61%)
...
**Resource Management:**
- **Manpower** - Recruits infantry and basic units
- **Munitions** - Upgrades weapons and abilities
- **Fuel** - Builds vehicles and tanks

**Territory Control:**
- Capture and hold **Strategic Points** to generate resources
- Connect points to your **HQ** for maximum efficiency
- Cut off enemy supply lines to starve their economy

**Cover System:**
- **Green Cover** (walls, sandbags) - Best protection
- **Yellow Cover** (craters, low walls) - Moderate protection
- **Red Cover** (open ground) - No protection, avoid at all costs
- **Negative Cover** (windows, some positions) - Increased damage taken
...
- **Backspace** - Center on HQ

### Important Tips

> [!TIP]
> **Always use cover!** Units in green cover can survive 3-4x longer than units in the open. Position is everything in Company of Heroes.

- **Flank enemy positions** - Attack from multiple angles
- **Preserve veteran units** - They gain experience and become more effective
- **Use combined arms** - Infantry, tanks, and support units work best together
- **Retreat damaged units** - Don't let squads die unnecessarily
- **Capture resources early** - Economy wins games
...
- Flank machine gun nests - never attack them head-on
- Use smoke grenades to advance safely
- Engineers can destroy bunkers with satchel charges

**Tips:**
- Keep your squads spread out to minimize mortar damage
- Use craters and destroyed obstacles for cover
- Rangers are powerful but fragile - keep them behind cover
...
- Build a Barracks to produce more infantry
- Use riflemen as your main fighting force
- Engineers should build sandbags for defensive positions
- Clear buildings with grenades before entering

**Tips:**
- Garrison buildings for excellent defensive positions
- Watch for German counterattacks from multiple directions
- Upgrade your units at the base when you have munitions
...
- Build defensive positions around captured points
- Use machine gun teams to lock down approaches
- Mortar teams counter enemy machine guns

**Tips:**
- Don't overextend - hold 2-3 points securely rather than losing all points
- Build observation posts on strategic points for reinforcements
- Save munitions for defensive abilities during counterattacks
...
- Build sandbags, barbed wire, and mines
- Position AT guns to counter German armor
- Keep reserves ready to plug gaps in your line
- Use artillery strikes on massed enemy formations

**Tips:**
- Repair damaged structures between waves
- Rotate damaged units to the rear for reinforcement
- Focus fire on German officers to reduce enemy effectiveness
- Save your off-map artillery for critical moments
...
- Flank machine gun nests with multiple squads
- Sherman tanks can destroy buildings and bunkers
- Clear buildings systematically, don't rush

**Tips:**
- Use bazookas or AT guns against German armor
- Garrison cleared buildings to secure your advance
- Watch for German reinforcements from the edges of the map
...
- Build a strong combined arms force
- Use tanks to lead the advance with infantry support
- Destroy bunkers with tank fire or satchel charges
- Capture fuel points to produce more armor

**Tips:**
- German 88mm guns are deadly to tanks - destroy them with artillery or infantry
- Use naval bombardment ability on fortified positions
- Keep engineers with your tanks for repairs
...
- Use infantry to spot for your AT guns
- Mines are extremely effective against German tanks
- Control the high ground for better firing positions

**Tips:**
- German Panthers and Tigers are tough - focus fire with multiple AT weapons
- Use sticky bombs and bazookas from close range
- Flank German tanks to hit their weaker rear armor
...
- Send engineers first to build defenses on the far side
- Establish a strong defensive perimeter
- Bring up AT guns and armor once the bridgehead is secure
- Expect fierce German counterattacks

**Tips:**
- Don't send all units across at once - you'll be vulnerable
- Build bunkers and fighting positions on the far bank
- Keep reserves ready to reinforce the bridgehead
...
- Use your own artillery to soften defenses
- Capture the hill in stages, consolidating each position
- Prepare for German counterattack once you take the summit

**Tips:**
- Mortars are excellent for clearing hilltop positions
- Use multiple attack routes to divide German defenses
- Veteran units are crucial for this difficult mission
...
- Clear buildings methodically with grenades
- Use tanks to destroy fortified positions
- Watch for German panzerschrecks in buildings
- Capture resource points to sustain your offensive

**Tips:**
- Flamethrowers are devastating in urban combat
- Don't bunch up units - German mortars punish clustering
- Use smoke to cross open streets
...
- Destroy German AT guns before advancing armor
- Capture fuel points to replace losses
- Push aggressively but don't overextend

**Tips:**
- German defensive positions are strong - use artillery
- Flank whenever possible
- Keep infantry with your tanks to spot AT guns
...
- Build extensive defenses - mines, wire, bunkers
- Position AT guns to create kill zones
- Use artillery on German armor concentrations
- Hold the high ground at all costs

**Tips:**
- This is one of the hardest missions - be patient
- Repair and reinforce between attacks
- Use off-map abilities wisely - you'll need them
- Focus on destroying German tanks - they're the main threat
...
- Capture abandoned German equipment
- Don't let the enemy establish new defensive lines
- Push hard but watch for ambushes

**Tips:**
- Speed is essential - don't get bogged down
- Use recon units to spot ahead
- German forces are weakened but still dangerous
...
- Coordinate infantry and armor advances
- Destroy German bunkers and strongpoints
- Capture resources to sustain the offensive

**Tips:**
- This mission tests everything you've learned
- Use all unit types effectively
- Veteran units from previous missions are very valuable

---

### Mission 15: Chambois (Final Mission)
...
- Massive German forces trying to escape
- Use all available resources and abilities
- Coordinate attacks on multiple fronts
- Prevent German breakout attempts

**Tips:**
- This is the culmination of the campaign - use everything you've learned
- German forces are desperate and will fight hard
- Use artillery and air strikes liberally
- Victory here completes the US Campaign!
...
- Bren carriers provide mobile fire support
- Capture and hold resource points
- Build emplacements for defense

**Tips:**
- British infantry is strong in cover
- Use smoke from mortars to advance
- Emplacements are powerful but immobile
...
- Use artillery to soften German positions
- Advance in stages, consolidating each position
- Build defensive emplacements once you capture the hill
- Prepare for fierce German counterattacks

**Tips:**
- Hill 112 is historically significant and heavily defended
- Use Cromwell tanks to support the assault
- AT emplacements counter German armor
...
- Use tanks to destroy fortifications
- Watch for German armor
- Capture resources to build up forces

**Tips:**
- German resistance is strong here
- Use combined arms tactics
- Prepare for the next mission's airfield assault

---

### Mission 4: Carpiquet - The Airfield
...
- German armor is a major threat
- Use AT guns and tank destroyers
- Capture the airfield in sections
- Build defenses to hold your gains

**Tips:**
- The airfield is heavily fortified
- Use artillery on bunkers and emplacements
- Churchill tanks are excellent for this mission
...
- Consolidate forces and prepare defenses
- Hold against waves of German attacks
- Use all available resources

**Tips:**
- Time pressure - move quickly to the rescue
- Once consolidated, build strong defenses
- German attacks come from multiple directions

---

### Mission 6: Caen - Into the City
...
- Clear buildings systematically
- Use tanks to destroy fortified positions
- Watch for German AT weapons in buildings
- Advance slowly and carefully

**Tips:**
- Caen is heavily defended - expect tough fighting
- Use flamethrowers and grenades in buildings
- Don't rush - urban combat is deadly

---

### Mission 7: Caen - The Crucible

**Objectives:**
- Continue the assault on Caen
...
- Use overwhelming firepower
- Coordinate infantry and armor
- Capture and hold key buildings

**Tips:**
- This is one of the hardest missions in the campaign
- Use artillery on fortified buildings
- Preserve veteran units - you'll need them

---

### Mission 8: Caen - Storm Front

**Objectives:**
- Final assault on Caen
...
- Coordinate attacks on multiple fronts
- Destroy German command posts
- Push to the final objectives

**Tips:**
- German forces are desperate - expect fierce resistance
- Use strategic bombing runs on strongpoints
- Victory is close - stay focused

---

### Mission 9: Bourguébus - Marching Onward (Final Mission)
...
**Strategy:**
- **Tank battle finale**
- Massive German armor presence
- Use AT guns, tank destroyers, and artillery
- Control the battlefield with superior positioning
- Destroy German Panthers and Tigers

**Tips:**
- This is the ultimate test of British armor tactics
...
## Part 4: Tales of Valor - Tiger Ace Campaign

*The Legend of Michael Wittmann - 3 Missions*

This mini-campaign follows German tank ace Michael Wittmann and his Tiger I tank crew through legendary battles in Normandy.

### Tiger Tank Mechanics

**Unique Features:**
- **Tiger I Tank** - Extremely powerful but slow
- **Ammunition Types** - Switch between AP and HE rounds
- **Repairs** - Manage tank damage during combat
- **Limited Resources** - Preserve your Tiger at all costs
- **Elite Crew** - Veteran abilities and bonuses

---

### Mission 1: Villers-Bocage - Birth of a Legend

**Objectives:**
- Ambush Allied convoy
- Destroy enemy tanks
...
- Position for ambushes - don't charge into the open
- Switch ammo types: AP for tanks, HE for infantry
- Destroy Fireflies first - they can penetrate your armor
- Manage repairs during lulls in combat

**Tips:**
- The Tiger is powerful but not invincible
- Use terrain and buildings for cover
- Flanking shots are more effective
- Preserve your tank - if it's destroyed, mission fails
- AT guns are dangerous - destroy them from range

---

### Mission 2: (Tiger Ace Campaign Continues)

**Objectives:**
- Continue Wittmann's exploits
...
- Avoid Tiger's weaknesses - slow speed and vulnerability to flanking
- Support infantry helps protect your tank
- Use abilities wisely

**Tips:**
- Veteran crew abilities are powerful - use them
- Repair between engagements
- Position is everything with the Tiger

---

### Mission 3: (Tiger Ace Campaign Finale)
...
- Face overwhelming Allied numbers
- Use superior German armor and tactics
- Coordinate with supporting units
- Achieve legendary status

**Tips:**
- This is the hardest Tiger Ace mission
- Use everything you've learned
- The Tiger is a legend - fight like one
- Victory here completes the Tiger Ace Campaign!

---

## Part 5: Tales of Valor - Causeway Campaign

*82nd Airborne at La Fiere - 3 Missions*

This mini-campaign follows paratroopers from the 82nd Airborne Division as they fight to secure the La Fiere causeway during D-Day.

### Airborne Mechanics

**Unique Features:**
- **Paratroopers** - Elite infantry units
- **Light Equipment** - Limited heavy weapons initially
- **Defensive Focus** - Hold against superior forces
- **Reinforcements** - Gradual buildup of strength
- **Team Survival** - Keep key squads alive

---

### Mission 1: Cauquigny - Drop on the Causeway

**Objectives:**
- Survive the drop
- Link up with other squads
- Clear Chef-du-Pont
...
- Clear towns methodically
- Use cover extensively - you're outnumbered
- Conserve ammunition and abilities
- Reach Cauquigny to establish a base

**Tips:**
- Paratroopers are elite but fragile
- Use grenades wisely - limited supply
- Stick together - lone squads die quickly
- Upgrade squads when possible
...
- Build defensive structures
- Position squads in cover
- Use limited resources wisely
- Hold key positions
- Counterattack to regain lost ground

**Tips:**
- German attacks are relentless
- Rotate damaged squads to the rear
- Use abilities to break up German assaults
- Reinforcements eventually arrive - hold until then

---

### Mission 3: Operation Grey Castle (Final Mission)
...
- Use all available forces
- Coordinate infantry assaults
- Destroy German armor
- Capture the castle
- Secure final victory

**Tips:**
- This is personal - the enemy tank killed your sergeant
- Use AT weapons effectively
- Clear the castle methodically
- Victory here completes the Causeway Campaign!
...
- Connect points to HQ for full income
- Build **Observation Posts** on key points
- Cut enemy supply lines when possible
- Balance spending between units and upgrades

**Resource Priorities:**
- **Early Game:** Manpower for infantry and territory control
- **Mid Game:** Fuel for vehicles and armor
- **Late Game:** Munitions for abilities and upgrades
...
**Infantry Combat:**
- **Always use cover** - green cover is best
- **Flank enemy positions** - attack from multiple angles
- **Focus fire** - concentrate on one enemy squad at a time
- **Retreat damaged units** - preserve veterancy
- **Use abilities** - grenades, smoke, suppression

**Armor Combat:**
- **Combined arms** - never send tanks alone
- **Infantry support** - protects tanks from AT infantry
- **Flanking** - rear armor is weaker
- **Repairs** - keep engineers with your armor
- **Target priority** - destroy AT threats first

**Defensive Tactics:**
- **Layered defenses** - multiple lines of resistance
- **Mines and wire** - slow enemy advances
- **Overlapping fields of fire** - support positions cover each other
- **Reserves** - keep units ready to counterattack
- **Fallback positions** - prepare secondary lines
...
**Veterancy:**
- Veteran units are much more effective
- Preserve experienced squads
- Use retreat to save units
- Veteran units unlock special abilities

**Unit Composition:**
- **Infantry** - Capture territory, provide vision
- **Machine Guns** - Suppress and pin enemy infantry
- **Mortars** - Counter enemy machine guns and emplacements
- **AT Guns** - Destroy enemy armor
- **Tanks** - Breakthrough and exploitation
- **Engineers** - Build defenses, repair vehicles, clear obstacles
...
**Flanking:**
- Attack from multiple directions
- Force enemy to split attention
- Hit weak points in enemy lines
- Use speed and mobility

**Suppression:**
- Machine guns suppress enemy infantry
- Suppressed units move slowly and fight poorly
- Use suppression to pin enemies while flanking
- Mortars counter enemy machine guns

**Combined Arms:**
- Use all unit types together
- Infantry spots for tanks
- Tanks destroy fortifications
- Artillery softens defenses
- Engineers support the advance

---

## Frequently Asked Questions

### Q: Which campaign should I play first?
**A:** Start with the **US Campaign** (base game). It's the tutorial campaign and teaches core mechanics. Then play British and Panzer Elite campaigns from Opposing Fronts, and finish with the Tales of Valor mini-campaigns.

### Q: What difficulty should I choose?
**A:** 
- **Easy** - Learn mechanics and enjoy the story
- **Normal** - Balanced challenge, recommended for first playthrough
- **Hard** - Requires strong tactical skills
- **Expert** - For experienced RTS players only

### Q: How important is cover?
**A:** **Extremely important!** Units in green cover survive 3-4x longer than units in the open. Always position your units in cover and flank enemies to negate their cover.

### Q: Should I build defenses or attack?
**A:** It depends on the mission. Some missions are defensive (hold positions), others are offensive (capture objectives). Read the mission briefing and adapt your strategy.

### Q: How do I counter enemy tanks?
**A:**
- **AT Guns** - Powerful but immobile
- **Tank Destroyers** - Mobile AT platforms
- **Bazookas/Panzerschrecks** - Infantry AT weapons
- **Mines** - Cheap and effective
- **Flanking** - Attack rear armor with your own tanks

### Q: What's the best way to assault fortified positions?
**A:**
1. Use **artillery** or **mortars** to suppress defenders
2. Use **smoke** to advance safely
3. **Flank** from multiple directions
4. Use **tanks** to destroy bunkers and emplacements
5. Clear buildings with **grenades** and **flamethrowers**

### Q: How do I defend against enemy attacks?
**A:**
1. Build **defensive structures** - sandbags, wire, mines
2. Position **machine guns** to cover approaches
3. Place **AT guns** to counter enemy armor
4. Keep **reserves** ready to counterattack
5. Use **artillery** on enemy concentrations

### Q: Can I skip missions?
**A:** No, campaigns are linear. You must complete each mission to progress to the next.

### Q: Are there different endings?
**A:** No, each campaign has a single ending. However, your performance (medals earned) affects your overall rating.

### Q: What are medals and how do I earn them?
**A:** Medals are bonus objectives in missions. They're optional but provide additional challenges. Check mission objectives for medal requirements.
...
### Q: What's the difference between the factions?
**A:**
- **US Forces:** Versatile, strong infantry, good armor
- **British Forces:** Defensive, emplacements, heavy tanks
- **Panzer Elite:** Mobile, fast vehicles, tactical abilities
- **Wehrmacht (in skirmish):** Balanced, strong late-game armor

### Q: Are there any missable achievements?
**A:** The Steam version of Company of Heroes does not include achievements. Focus on enjoying the campaigns and earning medals!

### Q: Should I use a walkthrough on my first playthrough?
**A:** The US Campaign teaches you the basics. Try missions on your own first, and consult this guide if you get stuck. Learning through trial and error is part of the fun!

### Q: What happens after I complete all campaigns?
**A:** You can:
- Replay missions for medals
- Try higher difficulties
- Play **Skirmish mode** against AI
- Play **Multiplayer** (if servers are still active)
- Try **custom maps** from the community
...
**[🏠 Return to Walkthroughs](README.md)** | **[🏠 Return to Main Archives](../README.md)**
