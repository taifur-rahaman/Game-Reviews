# Syberia - Complete Walkthrough

<div align="center">

## 🦣 The Journey of Kate Walker 🦣
*A comprehensive, step-by-step guide based on the expert strategies of "Estoy Loco" and other community masters.*
...
- [Part 1: Valadilène](#part-1-valadilène)
- [Part 2: Barrockstadt](#part-2-barrockstadt)
- [Part 3: Komkolzgrad](#part-3-komkolzgrad)
- [Part 4: Aralbad](#part-4-aralbad)
- [Part 5: Return to Komkolzgrad](#part-5-return-to-komkolzgrad)
- [Part 6: Return to Aralbad](#part-6-return-to-aralbad)

---

## General Tips

*   **Controls:** Left-click to move/interact. Double-click to run. Right-click for inventory.
*   **Documents:** Read every document (Click the "Eye" icon in inventory). They act as triggers for dialogue and phone numbers.
*   **Phone:** Use your cell phone to call numbers found in documents.
*   **Momo:** He is annoying but useful. Use him when brute force is needed.
...
### The Hotel & Arrival
1.  **Lobby:** 
    *   Pick up the **Advertising Brochure** from the notice board on the wall to the right of the staircase.
...
2.  **Room #6:**
    ...
    *   Use your **Cell Phone** to call the Office (**12-458-902**).
    *   Go downstairs.
3.  **Lobby (Again):**
...
### The Notary
1.  **Main Street:**
    *   Walk left towards the Notary's house (the one with the automaton at the door).
    *   Pick up the **Valadilène Gazette** from the bench outside the house. Read it.
2.  **Notary's Door:**
...
3.  **Notary's Office:**
    ...
    *   Talk to the Notary about "Mission". Receive the **Deed of Sale**.
    *   He enters his room and leaves you with **Anna's Letter**. Read it.
4.  **Leaving:**
    *   Check the coat rack near the entrance. Pick up the **Telescopic Key**.
    *   Exit the building.

### The Cemetery & Church (The Secret Key)
*This section is crucial for unlocking the full story and getting factory access items.*

1.  **Entrance:**
    *   Go to the Church area (keep walking right/NE from the hotel/fountain area).
    *   Enter the church gate.
2.  **Priest's Quarters:**
    *   Walk past the church main doors to the back right side. Enter the Priest's room.
    *   Look at the crucifix on the wall. Examine it to find the **Priest's Key**.
    *   **Dresser Puzzle:**
        *   Unlock the top drawer with the **Priest's Key**. Take the **Purple Punch Card**.
...
3.  **The Mausoleum:**
    ...
    *   Enter the crypt.
    *   Open the drawer marked "Hans Voralberg".
    *   He is not there! Pick up the **Valadilène Voice Cylinder** and the **Press Cut**.
4.  **Church Attic:**
    *   Go to the elevator on the side of the church (near where you entered the grounds).
    *   **Puzzle (Gears):**
...
1.  **Factory Gate:**
    *   Go to the main factory gates (SW of town).
    *   **Puzzle (Gate):**
...
### The Cave & Dam
1.  **The Chase:**
    *   Follow Momo past the hotel, out of town, to the park/dam area (follow the road left of the factory gate).
    *   Climb the stairs to the dam.
2.  **Opening the Dam:**
    *   Try the dam wheel (stuck).
...
4.  **Oscar:**
    ...
    *   Give **Wooden Legs** to the hanging automaton (Oscar). He leaves for the station.

### The Train Departure
1.  **Formalities:**
    *   Go to the Station (North path from fountain).
    *   Talk to Oscar in the ticket booth. Get **Ticket** and **Release Permit**.
    *   **Notary:** Run back to the Notary's office.
...
3.  **Rectors & Pons:**
    ...
    *   Talk to Professor Pons (Skeleton Hall). Ask about "Hans" and "Sauvignon".
    *   Give Pons the **Mammoth Doll**. He opens his lab.
    *   **Pons' Lab:**
...
5.  **The Wall:**
    ...
    *   **Curing the Captain:**
        ...
        *   Inspect his glasses on the desk.
        *   Pour **Wine** into the glasses.
        *   Add **Yangala-Cola Powder**.
        *   Kate toasts him. His vision clears.
    *   He gives you the **Exit Visa**.
    *   Given Visa to Oscar. Get **Ticket**. Give Ticket. Depart.
...
## Part 5: Return to Komkolzgrad

1.  **Escape:**
    *   Helena sings to distract Serguei.
    *   Use **Metal Shears** on the cage lock.
    *   Run to the Organ room.
